...
export default function Topbar() {
    ...
    return (
        <header className="h-16 bg-slate-900/80 backdrop-blur-md border-b border-slate-800 flex items-center justify-between px-8 sticky top-0 z-10 w-full transition-colors dark:bg-slate-900/80 dark:border-slate-800 bg-white/80 border-slate-200">
            <div>
